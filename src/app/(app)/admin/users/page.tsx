...
import { beDate } from "@/lib/reference";
  ...
  return (
    <div style={{ animation: "fadeUp .4s ease both" }}>
      <div style={{ paddingBottom: 26, borderBottom: "1px solid var(--line2)" }}>
        ...
        <p style={{ color: "var(--sub)", margin: "14px 0 0", fontSize: 16, maxWidth: "60ch" }}>เพิ่มบัญชี กำหนดบทบาทและงานสังกัด ตั้งรหัสผ่าน และเปิด/ปิดการใช้งาน · {users.length} บัญชี</p>
      </div>
