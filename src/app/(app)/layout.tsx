...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      />
      <main style={{ flex: "1 1 auto", width: "100%", maxWidth: "var(--page-max)", margin: "0 auto", padding: "clamp(24px,4vw,48px) clamp(16px,3vw,32px)" }}>
        {children}
      </main>
      <footer style={{ borderTop: "1px solid var(--line2)", marginTop: 40 }}>
        <div style={{ maxWidth: "var(--page-max)", margin: "0 auto", padding: "22px clamp(16px,3vw,32px)", display: "flex", flexWrap: "wrap", gap: "12px 24px", alignItems: "center", justifyContent: "space-between", fontFamily: "var(--mono)", fontSize: 12, letterSpacing: ".06em", color: "var(--faint)" }}>
